...
export default function DealModal({ deal, onClose }: DealModalProps) {
  ...
  useEffect(() => {
    if (deal) {
      ...
      // Сбрасываем индекс при открытии новой сделки
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="grid lg:grid-cols-2 h-full">
                {/* Image carousel */}
                {images.length > 0 ? (
                  <div className="relative h-64 sm:h-80 lg:h-full overflow-hidden bg-neutral-100">
                  ...
                  <div className="relative h-64 sm:h-80 lg:h-full overflow-hidden bg-neutral-100 flex items-center justify-center">
                    <div className="text-center text-neutral-400">
                      <svg className="w-24 h-24 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                      </svg>
                      <p className="text-lg">Нет изображений</p>
                    </div>
                  </div>
                )}
                ...
                <div className="p-6 lg:p-10 flex flex-col">
                  ...
                  {/* Description */}
                  <div className="mb-8">
                    <h3 className="text-neutral-900 font-semibold mb-3">Информация о сделке</h3>
                    <p className="text-neutral-600 leading-relaxed">
                      Успешно завершённая сделка. {deal.note} в районе {deal.district}.
                      {deal.dateLabel && ` Сделка завершена в ${deal.dateLabel}.`}
                    </p>
                  </div>
